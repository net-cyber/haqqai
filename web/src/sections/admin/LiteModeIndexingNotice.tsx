    ...
    <Section padding={2}>
      <IllustrationContent
        ...
        description={markdown(
          `This deployment runs HaqqAI Lite, which has no vector database — connectors and document indexing are disabled, and nothing is indexed. To connect data sources and index documents, deploy HaqqAI in **Standard mode**. See the [deployment guide](${DEPLOYMENT_DOCS_URL}) to get started.`
        )}
      />
    </Section>
  );
