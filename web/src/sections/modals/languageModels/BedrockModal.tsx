    ...
    <>
      <InputPadder>
        <Section gap={1}>
          ...
          <InputVertical
            ...
            subDescription="Choose how HaqqAI should authenticate with Bedrock."
          >
      ...
      {authMethod === AUTH_METHOD_IAM && (
        <InputPadder>
          <MessageCard
            variant="info"
            title="HaqqAI will use the IAM role attached to the environment it’s running in to authenticate."
          />
        </InputPadder>
      )}
