...
> = {
  web: {
    ...
    values: [
      {
        type: "text",
        query: "Enter the website URL to scrape e.g. https://docs.HaqqAI.app/:",
        label: "Base URL",
        name: "base_url",
        optional: false,
      },
  ...
  google_drive: {
            ...
            fields: [
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow HaqqAI to index everything in the shared drives you have access to."
                    : "This will allow HaqqAI to index everything in your Organization's shared drives.";
                },
              ...
              },
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow HaqqAI to index everything in your My Drive."
                    : "This will allow HaqqAI to index everything in everyone's My Drives.";
                },
              ...
              },
              {
                type: "checkbox",
                description:
                  "This will allow HaqqAI to index all files shared with you.",
    ...
    advanced_values: [
      ...
      },
      {
        ...
        description:
          "When enabled, HaqqAI skips files that are shared broadly (domain or public) but require the link to access.",
            ...
            fields: [
              {
                ...
                optional: true,
                description:
                  "Specify the Salesforce object types you want us to index. If unsure, don't specify any objects and HaqqAI will default to indexing by 'Account'." +
...
• Specifying sites currently works for SharePoint instances using English, Spanish, or German. Contact the HaqqAI team if you need another language supported.
`,
      },
    ],
    advanced_values: [
      ...
      },
      {
        ...
        description:
          ...
          "are treated as public (visible to all HaqqAI users). " +
    ...
    values: [
      {
        ...
        name: "base_url",
        optional: false,
        description: `Specify the base URL for your Slab team. This will look something like: https://HaqqAI.slab.com/`,
      },
    ],
    advanced_values: [],
  },
