          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex flex-col items-center gap-2 text-center max-w-sm">
              ...
              <Text font="main-ui-body" color="text-03">
                {isPaidUser
                  ? `You've used all ${limits?.limit ?? 25} messages for this week. Your message limit will automatically reset at the start of each week, allowing you to continue crafting with HaqqAI.`
