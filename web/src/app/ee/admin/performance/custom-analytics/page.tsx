...
function Main() {
      ...
      <div>
        <div className="mt-4">
          <Callout type="danger" title="Custom Analytics is not enabled.">
            ...
            setup HaqqAI in your team to set the{" "}
  ...
  return (
    <div>
      <Text as="p">
        {
          "This allows you to bring your own analytics tool to HaqqAI! Copy the Web snippet from your analytics provider into the box below, and we'll start sending usage events."
        }
      </Text>
      <Spacer rem={2} />
