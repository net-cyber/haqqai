        ...
        <Modal.Body>
          <div className="flex flex-col gap-2">
            <Text font="main-ui-body" color="text-03">
              {markdown(
                `HaqqAI will stop calling this endpoint for hook ***${hook.name}***. In-flight requests will continue to run. The external endpoint may still retain data previously sent to it. You can reconnect this hook later if needed.`
              )}
            </Text>
            <Text font="main-ui-body" color="text-03">
    ...
    <>
      ...
      <SettingsLayouts.Root>
        <SettingsLayouts.Header
          icon={route.icon}
          title={route.title}
          description="Extend HaqqAI pipelines by registering external API endpoints as callbacks at predefined hook points."
          divider
        />
