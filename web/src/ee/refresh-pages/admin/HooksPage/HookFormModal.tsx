...
const SOFT_DESCRIPTION =
  "If the endpoint returns an error, HaqqAI logs it and continues the pipeline as normal, ignoring the hook result.";
...
function TimeoutField({ spec }: TimeoutFieldProps) {
  ...
  return (
    <InputVertical
      ...
      title="Timeout"
      suffix="(seconds)"
      subDescription={`Maximum time HaqqAI will wait for the endpoint to respond before applying the fail strategy. Must be greater than 0 and at most ${MAX_TIMEOUT_SECONDS} seconds.`}
    >
              ...
              <Form className="w-full overflow-visible">
                ...
                <Modal.Body>
                  ...
                  <InputVertical
                    withLabel="api_key"
                    title="API Key"
                    subDescription="HaqqAI will use this key to authenticate with your API endpoint."
                  >
