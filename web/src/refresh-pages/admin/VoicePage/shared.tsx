                  ...
                  {providerType === "azure" && (
                    <InputVertical
                      ...
                      subDescription={markdown(
                        "Paste the endpoint shown in [Azure Portal (Keys and Endpoint)](https://portal.azure.com/). HaqqAI extracts the speech region from this URL. Examples: `https://westus.api.cognitive.microsoft.com/` or `https://westus.tts.speech.microsoft.com/`."
                      )}
                  ...
                  {mode === "tts" && (
                    <>
                      {(detail.ttsModels?.length ?? 0) > 1 && (
                        <InputVertical
                          title="Default Model"
                          subDescription="This model will be used by HaqqAI by default for text-to-speech."
                          withLabel="tts_model"
                        >
